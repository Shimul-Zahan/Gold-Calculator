...
const About = () => {
    return (
        <section className='min-h-screen font-sans max-w-7xl mx-auto space-y-5 pb-10 px-2 lg:p-10 rounded-xl my-5 bg-[#005697] text-white'>
            ...
            <div>
                ...
                <p className='lg:text-[30px]'>ТОО «Ломбард Гарант KZ» на финансовом рынке Казахстана работает с февраля 2011 года. <br /> <br />
            ...
            <div>
                ...
                <p className='lg:text-[30px]'>Выдана 25.03.2021 г. Управлением региональных представителей в г.Караганда Агентства Республики Казахстан по регулированию и развитию финансовых рынков
                </p>
            </div>
